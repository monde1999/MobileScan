...
package com.citu.mobilescan.helpers;
...
public class PointClusteringHelper {
     ...
     */
    public List<com.citu.mobilescan.helpers.AABB> findClusters() {
        ...
        List<com.citu.mobilescan.helpers.AABB> clusters = new ArrayList<>();
    ...
    private void allocateGrid(FloatBuffer points) {
        ...
        com.citu.mobilescan.helpers.AABB bounds = new com.citu.mobilescan.helpers.AABB();
        points.rewind();
    ...
    private com.citu.mobilescan.helpers.AABB computeAABB(List<int[]> cluster) {
