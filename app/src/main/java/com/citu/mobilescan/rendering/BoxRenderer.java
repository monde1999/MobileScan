...
package com.citu.mobilescan.rendering;
...
public class BoxRenderer {
    ...
    public void createOnGlThread(Context context) throws IOException {
        com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Create");
        int vertexShader =
                com.citu.mobilescan.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
        int fragmentShader =
                com.citu.mobilescan.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
        ...
        com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Program");
        ...
        com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Init complete");
    }
    ...
    public void draw(AABB aabb, Camera camera) {
        ...
        GLES20.glVertexAttribPointer(vPosition, 3,
                ...
                12, vertexBuffer);
        com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Draw");
        ...
        com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Draw complete");
    }
}
