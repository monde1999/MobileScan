...
public class BackgroundRenderer {
  ...
  public void createOnGlThread(Context context) throws IOException {
    ...
    int vertexShader =
            com.citu.mobilescan.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, CAMERA_VERTEX_SHADER_NAME);
    int fragmentShader =
            com.citu.mobilescan.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, CAMERA_FRAGMENT_SHADER_NAME);
    ...
    com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Program creation");

    quadPositionParam = GLES20.glGetAttribLocation(quadProgram, "a_Position");
    quadTexCoordParam = GLES20.glGetAttribLocation(quadProgram, "a_TexCoord");

    com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
  }
  ...
  private void draw() {
    ...
    com.citu.mobilescan.rendering.ShaderUtil.checkGLError(TAG, "BackgroundRendererDraw");
  }
